        ...
        function getQuestionBank(id, name) {
            ...
            for(var i=0;i<20 ;i++){
                ...
                document.getElementById("tr_"+(i+1)+"").innerHTML="" +
                    ...
                    "<td>"+ difficulty +"</td>\n" +
                    "<td>"+ condition +"</td>\n"+
                    "<td>"+"<a class='a1' href='StrategyChange.html'><img src='${pageContext.request.contextPath }/views/img/update.png'></a>"+
                    "<a class='a1' href='QuestionCheckMore.html'><img src='${pageContext.request.contextPath }/views/img/check.png'></a>"+"</td>"
                    ;
            }
        ...
        <tr id="0">
            <td>
                <a class="showHideButton" href="javascript:void(0)" onclick="getSubDirectory(1)"><img
                        src="${pageContext.request.contextPath }/views/img/plus.gif" alt="plus"></a>
            </td>
