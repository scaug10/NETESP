...
<body>
	<div id="pageAll">
		...
		<div class="pageTop">
			<div class="page">
				<img src="${pageContext.request.contextPath}/views/img/coin02.png" /><span><a href="${pageContext.request.contextPath}/index">首页</a>&nbsp;-&nbsp;<a
					href="${pageContext.request.contextPath}/getAllKnowledge">知识管理</a>&nbsp;-</span>&nbsp;添加知识信息
			</div>
		</div>
		<div class="page ">
			<!-- 内容页面样式 -->
